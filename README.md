...
### Алгоритм решения
Создаем тестовый класс. В методе получаем класс обьекта, проверяем есть ли аннотация, если нет, выбрасываем ошибку. Берем массив классов из аннотаци, проверяем не пуст ли он. Если ошибка не выбрасывавется - тест пройден,
в противном случае тест не пройден.
### Пример
